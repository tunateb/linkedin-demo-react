...
function UserProfilCard({name,location}) {
    ...
    return (
        <div className="profile-card">
            <div className="card-coverImg">
                <Image
                    coverPhoto
                    src="https://source.unsplash.com/800/180"
                />
            </div>
            <div className="profileCard-body">
                <div className="user-img">
                    <Image
                        circle
                        profilePic
                        src="https://source.unsplash.com/400/400"
                    />
                </div>
                <div className="profileCard-content">
                    <h5>{name}</h5>
                    <h6><i className="fas fa-location-arrow"></i>{location}</h6>
                ...
                <div className="profileCard-buttons">
                  <Buttons color="dark-blue">CONTACT INFO</Buttons>
                  <Buttons color="transparent"> 1,043 connections</Buttons>
                </div>
                </div>  
            </div>
        </div>
